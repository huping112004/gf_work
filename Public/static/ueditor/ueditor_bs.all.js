        ...
        render: function (container) {
            ...
            if (container) {
                ...
                var html = ( ie && browser.version < 9  ? '' : '<!DOCTYPE html>') +
                        '<html xmlns=\'http://www.w3.org/1999/xhtml\' class=\'ueditor-color\' ><head>' +
                        '<style type=\'text/css\'>' +
                        //设置四周的留边
                        '.ueditor-color{padding:0;word-wrap:break-word;cursor:text;height:90%;}\n' +
                        //设置默认字体和字号
                        //font-family不能呢随便改，在safari下fillchar会有解析问题
                        'body{margin:8px;font-family:sans-serif;font-size:16px;}' +
                        //设置段落间距
                        'div,p{border:1px dashed grey;}' +
                        'p{margin:5px 0;}</style>' +
                        '<link href=\'/Public/layouts/css/bootstrap.css\' rel=\'stylesheet\'>' + 
												'<link href=\'/Public/layouts/css/colour.css\' rel=\'stylesheet\'>' + 
                        '<link href=\'/Public/layouts/css/theme.css\' rel=\'stylesheet\'>' +
                        ( options.iframeCssUrl ? '<link rel=\'stylesheet\' type=\'text/css\' href=\'' + utils.unhtml(options.iframeCssUrl) + '\'/>' : '' ) +
                        (options.initialStyle ? '<style>' + options.initialStyle + '</style>' : '') +
                        '</head><body class=\'ueditor-color\' ></body>' +
...
//                });
        ...
        getAllHtml: function () {
            ...
            return '<html><head>' + (me.options.charset ? '<meta http-equiv="Content-Type" content="text/html; charset=' + me.options.charset + '"/>' : '')
                ...
                + '<body ' + (ie && browser.version < 9 ? 'class="ueditor-color"' : '') + '>' + me.getContent(null, null, true) + '</body></html>';
        },
        /**
...
UE.plugins['list'] = function () {
    ...
    //进入编辑器的li要套p标签
    me.addInputRule(function(root){
        // http://ys720.com/jiaocheng/qita/714.html
